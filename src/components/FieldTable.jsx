      ...
      <table className="w-full border-collapse text-left text-[13.5px]">
        <thead>
          <tr className="bg-ink-900/[0.03] dark:bg-[#000000]">
            ...
            <th className="px-4 py-3 font-semibold text-ink-800 dark:text-[#FFFFFF] border-b border-ink-900/10 dark:border-[#262626] w-[12%]">
              Required
            </th>
        ...
        <tbody>
          {rows.map((r, i) => (
            ...
            >
              <td className="px-4 py-3 align-top font-mono text-[12.5px] text-ink-900 dark:text-[#FFFFFF] font-medium">
                {r.field}
              </td>
