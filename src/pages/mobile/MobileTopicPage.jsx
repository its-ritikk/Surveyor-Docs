...
import { mobileDocsDictionary } from "../../data/mobileDocsData";

export default function MobileTopicPage({ topicKey }) {
  const data = mobileDocsDictionary[topicKey] || mobileDocsDictionary["overview"];
