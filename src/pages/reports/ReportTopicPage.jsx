...
import { reportsEcosystemDictionary } from "../../data/reportsEcosystemData";

export default function ReportTopicPage({ topicKey }) {
  const data = reportsEcosystemDictionary[topicKey] || reportsEcosystemDictionary["workflow-reports/overview"];
    ...
    >
      ...
      <Section id="related-modules" title="Related Modules">
        ...
        <div className="grid gap-2 sm:grid-cols-3 text-xs font-medium">
          <Link to="/reports/report-creation-methods" className="p-3 rounded-lg border border-ink-900/10 dark:border-[#262626] hover:bg-cyan-500/5 text-cyan-700 dark:text-cyan-400">
            Report Creation Methods →
          </Link>
          <Link to="/reports/report-builder" className="p-3 rounded-lg border border-ink-900/10 dark:border-[#262626] hover:bg-cyan-500/5 text-cyan-700 dark:text-cyan-400">
            Report Builder →
          </Link>
          <Link to="/reports/report-lifecycle" className="p-3 rounded-lg border border-ink-900/10 dark:border-[#262626] hover:bg-cyan-500/5 text-cyan-700 dark:text-cyan-400">
            Report Lifecycle →
          </Link>
        </div>
      </Section>
