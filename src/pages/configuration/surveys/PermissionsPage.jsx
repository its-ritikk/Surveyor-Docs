...
const toc = [
  ...
  { id: "rbac-matrix", label: "Role-Based Access Control Matrix" },
];
  ...
  return (
    ...
    >
      <Section id="overview" title="Overview">
        <p>
          Survey Builder features are strictly scoped by Role-Based Access Control (RBAC) to ensure only authorized administrators can modify published survey blueprints.
        </p>
      </Section>

      <Section id="rbac-matrix" title="Role-Based Access Control Matrix">
