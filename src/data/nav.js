    ...
    items: [
      { label: "Operations Dashboard", to: "/operations/dashboard" },
      {
        ...
        children: [
          ...
          { label: "Contract Documents", to: "/operations/contracts#contract-documents" },
          { label: "Status Management", to: "/operations/contracts#status-management" },
          { label: "Timeline", to: "/operations/contracts#timeline" },
          { label: "Search & Filters", to: "/operations/contracts#search-filters" },
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Timeline", to: "/operations/inspection-review#timeline" },
          ...
          { label: "Tutorial Video", to: "/operations/inspection-review#tutorial-video" },
        ],
      },
    ],
  },
        ...
        children: [
          ...
          { label: "Drag & Drop", to: "/configuration/surveys/drag-and-drop" },
          {
            ...
            children: [
              ...
              { label: "Signature", to: "/configuration/surveys/field-signature" },
