    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Operational Guidelines", to: "/operations/inspection-review/best-practices" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Workflow", to: "/configuration/surveys/workflow-workspace" },
          { label: "Survey Steps", to: "/configuration/surveys/survey-steps" },
          {
            ...
            children: [
              ...
              {
                label: "Multi Select",
                to: "/configuration/surveys/field-multiselect/overview",
                children: [
                  { label: "Overview", to: "/configuration/surveys/field-multiselect/overview" },
                  { label: "Configuration", to: "/configuration/surveys/field-multiselect/configuration" },
                  { label: "Options Management", to: "/configuration/surveys/field-multiselect/options-management" },
                  { label: "Validation", to: "/configuration/surveys/field-multiselect/validation" },
                  { label: "Troubleshooting", to: "/configuration/surveys/field-multiselect/troubleshooting" },
                ],
              },
        ...
        children: [
          ...
          { label: "Report Elements", to: "/reports/report-builder/elements" },
          {
            ...
            children: [
              ...
              { label: "Text", to: "/reports/report-builder/elements/rich-text" },
